...
import bf.gov.matm.entity.*;
import bf.gov.matm.repository.*;
...
public class DataInitializer implements CommandLineRunner {
    ...
    private void initArticles() {
        if (articleRepository.count() == 0) {
            ...
            articleRepository.save(Article.builder()
                    .title("Le MATM renforce la modernisation de l’administration territoriale")
                    .summary("Le Ministère de l’Administration territoriale et de la Mobilité poursuit ses actions pour moderniser l’administration territoriale et améliorer les services publics au Burkina Faso.")
                    .content("Le Ministère de l’Administration territoriale et de la Mobilité (MATM) œuvre au renforcement de l’administration territoriale et à l’amélioration de la mobilité au Burkina Faso. À travers ses différentes actions, le Ministère accompagne la modernisation des services publics, le renforcement de la gouvernance territoriale et l’amélioration des services liés à la mobilité.")
    ...
    private void initFAQs() {
        if (faqRepository.count() == 0) {
            ...
            f3.setAnswer("Vous pouvez nous contacter par téléphone au +226 25 30 XX XX, par email à contact@MATM.gov.bf, ou en vous rendant à nos bureaux situés à Ouagadougou.");
